...
**43 detection signatures · 29 CVE rules · 15 honeypot-active CVEs · 13 exploit-path probes**
...
- **Favicon hashing** (mmh3 of `/favicon.ico` → product DB) — not used by any signature.
